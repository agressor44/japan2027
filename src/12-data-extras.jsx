...
const OPTIONS = [
  { id: "o-disneysea", title: "Tokyo DisneySea", jp: "ディズニーシー", city: "tokyo", day: 3, tags: ["teens", "energy"], why: "The only DisneySea in the world. If you do one park, do this one.", cost: "¥¥¥", time: "Full day" },
  { id: "o-disneyland", title: "Tokyo Disneyland", jp: "ディズニーランド", city: "tokyo", day: 4, tags: ["teens", "energy"], why: "Familiar, but very well executed. Competes with a whole free Tokyo day.", cost: "¥¥¥", time: "Full day" },
  { id: "o-ghibli", title: "Ghibli Museum", jp: "ジブリ美術館", city: "tokyo", day: 4, tags: ["everyone", "traditional"], why: "Small, strange, wonderful. Getting nine tickets is the hard part.", cost: "¥", time: "3 hrs" },
  { id: "o-joypolis", title: "Tokyo Joypolis", city: "tokyo", day: 4, tags: ["teens", "energy", "anime"], why: "Indoor Sega theme park in Odaiba. Pure teen fuel.", cost: "¥¥", time: "3 hrs" },
  ...
  { id: "o-tokyotower", title: "Tokyo Tower", city: "tokyo", day: 6, tags: ["everyone", "views"], why: "Competes with Shibuya Sky and Skytree. Three towers is two too many.", cost: "¥¥", time: "1 hr" },
  { id: "o-monkey", title: "Iwatayama Monkey Park", city: "kyoto", day: 10, tags: ["teens", "outdoor"], why: "A real climb, wild macaques, and the best view over Kyoto.", cost: "¥", time: "1.5 hrs" },
  { id: "o-sagano", title: "Sagano scenic railway", city: "kyoto", day: 10, tags: ["everyone", "relaxed"], why: "Open-sided train through the gorge. Reserve ahead.", cost: "¥", time: "1 hr" },
  { id: "o-tea", title: "Tea ceremony", jp: "茶道", city: "kyoto", day: 10, tags: ["adults", "traditional"], why: "Quiet, formal, and genuinely different from everything else on the trip.", cost: "¥¥", time: "1 hr" },
  { id: "o-kimono", title: "Kimono rental", jp: "着物", city: "kyoto", day: 10, tags: ["everyone", "traditional"], why: "Kyoto or Osaka — pick one. Kyoto has the better backdrops.", cost: "¥¥", time: "Half day" },
  { id: "o-onsen", title: "Onsen or foot bath", jp: "温泉", city: "kyoto", day: 9, tags: ["adults", "relaxed"], why: "After the river day. Check tattoo policies per facility.", cost: "¥", time: "1.5 hrs" },
  { id: "o-kasuga", title: "Kasuga Taisha", city: "nara", day: 12, tags: ["adults", "traditional"], why: "Three thousand lanterns. Adds an hour to the Nara stop.", cost: "¥", time: "1 hr" },
  { id: "o-horyuji", title: "Hōryū-ji", jp: "法隆寺", city: "nara", day: 12, tags: ["adults", "traditional"], why: "The oldest wooden buildings on earth. Cut in favour of Nara Park — back on the table if someone wants it.", cost: "¥", time: "2 hrs", cut: true },
  { id: "o-usj", title: "Universal Studios Japan", city: "osaka", day: 14, tags: ["teens", "energy"], why: "Super Nintendo World. The strongest single teen pull of the trip.", cost: "¥¥¥", time: "Full day" },
  { id: "o-kaiyukan", title: "Osaka Aquarium Kaiyūkan", city: "osaka", day: 14, tags: ["everyone"], why: "Whale sharks. One of the largest aquariums anywhere.", cost: "¥¥", time: "3 hrs" },
  { id: "o-round1", title: "Round1 Stadium", city: "osaka", day: 14, tags: ["teens", "energy"], why: "Arcade, bowling, batting cages and karaoke stacked in one building.", cost: "¥¥", time: "2 hrs" },
  { id: "o-animalcafe", title: "Animal café", city: "osaka", day: 14, tags: ["teens", "relaxed"], why: "Cats, hedgehogs, owls — quality varies wildly. Research the specific one.", cost: "¥", time: "1 hr" },
  { id: "o-shinsekai", title: "Shinsekai & Tsūtenkaku", city: "osaka", day: 14, tags: ["everyone", "nightlife"], why: "1950s Osaka, preserved in neon and deep-fried skewers.", cost: "¥", time: "2 hrs" }
];
